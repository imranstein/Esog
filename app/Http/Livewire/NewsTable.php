    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('description', function (News $model) {
                return substr(e($model->description), 0, 50);
            })
            ->addColumn('image')
            ->addColumn('image', function (News $model) {
                return '<img src="' . e($model->image) . '" width="100" height="100" />';
            })
            ->addColumn('caption')
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            //->hide(),
            Rule::button('edit')
                ->when(fn () => Auth::user()->cannot('news-edit'))
                ->hide(),

            Rule::button('delete')
                ->when(fn () => Auth::user()->cannot('news-delete'))
                ->hide(),
        ];
    }
}
