...
final class PublicationTable extends PowerGridComponent
{
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Publication>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('title_lower', function (Publication $model) {
                return strtolower(e($model->title));
            })
            //limit the number of descriptiomn characters
            ->addColumn('description', function (Publication $model) {
                return substr(e($model->description), 0, 50);
            })
            ->addColumn('image')
            ->addColumn('image', function (Publication $model) {
                return '<img src="' . $model->image . '" width="100" height="100">';
            })
            ->addColumn('author')
            ->addColumn('document')
            ->addColumn('created_at_formatted', fn (Publication $model) => Carbon::parse($model->created_at)->format('d/m/Y H:i:s'));
    }
